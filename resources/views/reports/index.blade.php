...
@section('title', 'Relatórios - Ohnmacht')
                                ...
                                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <div class="flex items-center">
                                        <div class="w-16 bg-gray-200 rounded-full h-2 mr-2">
                                            <div class="bg-blue-600 h-2 rounded-full" style="width: {{ $totalLeads > 0 ? ($hotel->leads_count / $totalLeads) * 100 : 0 }}%"></div>
                                        </div>
                                    ...
                                    <div class="flex items-center">
                                        <div class="w-16 bg-gray-200 rounded-full h-2 mr-2">
                                            @php
                                                ...
                                                $percentage = $maxLeadsInDay > 0 ? ($dayData['count'] / $maxLeadsInDay) * 100 : 0;
                                            @endphp
